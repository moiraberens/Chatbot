...
class Seq2SeqModel(object):
  ...
  def get_batch(self, settings, data, buckets, bucket_id):
    "function made by Jeroen & Moira"
    encoder_size, decoder_size = buckets[bucket_id]
    
    encoder_inputs, decoder_inputs = [], []
    index_list = random.sample(range(0, len(data[bucket_id])-1), settings['batch_size'])
    
    for index in index_list:
        encoder_inputs.append(data[bucket_id][index][0])
        decoder_inputs.append(data[bucket_id][index][1])
